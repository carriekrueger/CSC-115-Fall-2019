...
public class StringNotes {
    ...
    public static void stringThings() {
        ...
        */
        ...
        // charAt(position) returns the characteer at the specified index 
        System.out.println(name.charAt(0)); // G 
        System.out.println(name.charAt(4)); // e 
        //System.out.println(name.charAt(5));  // error - no index 5 
           
        System.out.println();   
           
        // lots of methods to help standardize user input 
        
        // toUpperCase() returns the String in all UPPPERCASE

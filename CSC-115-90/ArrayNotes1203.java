...
public class ArrayNotes {
    public static void main(String[] args) {
        ...
        */ 
        ...
        // 4. Arrays are indexed from 0 to length - 1 (ArrayIndexOutOfBoundsException error) 
        ...
        /* 
              ...
              0   1   2   3   4   5   6          positions (indexes) from 0 to length - 1
            -----------------------------
        ...
        */ 
         ...
         // An array for a month of temperatures? Make an int array of size 30
         
         int[] monthlyTemps = new int[30];
         
         // print the first element in the array: index/position 0 
         System.out.println("First: " + temps[0]);
         
         // print the last element in this array: index/position 6 (seventh element)
         System.out.println("Last: " + temps[6]);
         
         // position 7?
         // System.out.println(temps[7]);   // ArrayIndexOutOfBoundsException
         
         // print out the last element in ANY array? index/position length - 1
         ...
         System.out.println();  // next thing will print on the next line
    ...
    // ** If you send an array as a parameter to a method and you change the array inside
    // the method, the changes will stick when the method is done 

...
public class MethodDemo {
        ...
        public static void main(String[] args) {
            ...
            // Could make a code displacer method (same with above input) but Scanner issues 
            ...
            if(choice == 1) {
                add(num1, num2);    // a method to show how PARAMETERS work 
            }
            ...
            if(choice == 4) {
                //int answer = exp(num1, num2);  // return a value and save it to a variable 
               // System.out.println(answer);
                
                System.out.println(exp(num1,num2));   // return to a print statement 
            }
        ...
        // This method takes two numbers and displays the sum 
        ...
        // This method takes two numbers and displays the quotient 
        ...
        // This method takes 2 ints.
        // It returns a raised to the b power.
        public static int exp(int a, int b) {
            
            // return Math.pow(a, b);      // cheat code... would have to change return type
                                            // to double 
